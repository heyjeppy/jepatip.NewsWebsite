	        ...
	        <div className="container flex justify-between h-10 mx-auto">
		        <div className="flex">
			        <a rel="Brand Name" href="#" aria-label="Back to homepage" className="flex items-center p-2">
                        <h3 className='text-yellow-400 text-lg font-bold font-sans'>yellowpad+</h3>
			        </a>
			        <ul className="items-stretch hidden space-x-2 ps-10 lg:flex">
				        <li className="flex">
							<Link to="/features" className="flex items-center px-4 -mb-1 font-semibold dark:border- dark:text-black-600 hover:text-yellow-400">News</Link>
				        </li>
				        <li className="flex">
							<Link to="/news" className="flex items-center px-4 -mb-1 font-semibold dark:border- dark:text-black-600 hover:text-yellow-400">Features</Link>
				        </li>
                        <li className="flex">
							<Link to="/articles" className="flex items-center px-4 -mb-1 font-semibold dark:border- dark:text-black-600 hover:text-yellow-400">Articles</Link>
				        </li>
			    	    <li className="flex">
				    	    <Link to="/features" className="flex items-center px-4 -mb-1 font-semibold dark:border- dark:text-black-600 hover:text-yellow-400">Latest News Updates</Link>
				        </li>
			        </ul>
		        </div>
		        <div className="flex items-center md:space-x-4">
			        <div className="relative">
				        ...
				        <input type="search" name="Search" placeholder="Search..." className="w-45 py-2 pl-10 text-sm rounded-md sm:w-auto focus:outline-none dark:bg-gray-100 dark:text-gray-800 focus:dark:bg-gray-50" id="search-input"/>
			        </div>
			        <button type="button" className="px-5 py-2 sl:px-3 sl:py-1 font-semibold rounded sl:rounded-lg dark:bg-yellow-300 hover:bg-yellow-400 dark:text-white" id='search-btn'>Search</button>
		        </div>
				...
				<div className="lg:hidden">
					<button className="navbar-burger flex items-center text-black p-3">
						<svg className="block h-4 w-4 fill-current" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"> 
							<title>Menu</title>
							<path d="M0 3h20v3H0V3zm0 6h20v2H0V9zm0 6h20v2H0v-2z"></path>
						</svg>
					</button>
				</div>
