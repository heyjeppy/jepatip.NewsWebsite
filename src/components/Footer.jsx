	...
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
			<a rel="" href="#" className="flex justify-center space-x-3 lg:justify-start">
				<span className="text-black-100 text-lg ps-10 font-sans self-center text-4xl font-bold">yellowpad+</span>
			</a>
		</div>
		<div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
			<div className="space-y-3">
				<h3 className="tracking-wide uppercase dark:text-gray-900 font-bold">NEWS</h3>
				<ul className="space-y-1">
					<li>
						<a rel="noopener noreferrer" href="#">Headlines</a>
					</li>
					<li>
						<a rel="noopener noreferrer" href="#">Features</a>
					</li>
					<li>
						<a rel="noopener noreferrer" href="#">Articles</a>
					</li>
					<li>
						<a rel="noopener noreferrer" href="#">Latest News Updates</a>
					</li>
				</ul>
			</div>
			<div className="space-y-3">
			...
			<div className="space-y-3">
				<h3 className="uppercase dark:text-gray-900 font-bold">About Yellowpad</h3>
				<ul className="space-y-1">
					<li>
					...
					<li>
						<a rel="noopener noreferrer" href="#">Leadership </a>
					</li>
					<li>
						<a rel="noopener noreferrer" href="#">Newsletters </a>
					</li>
				</ul>
			</div>
			<div className="space-y-3">
